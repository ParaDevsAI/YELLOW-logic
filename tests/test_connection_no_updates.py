"""
test_connection_no_updates.py
Teste SEM processar updates do Telegram
"""
import asyncio
import os
import logging
...
async def test_connection_no_updates():
    """Teste SEM processar updates."""
    print("🔍 TESTE SEM UPDATES")
    print("="*50)
    
    print("1️⃣ Criando cliente...")
    # DESABILITAR UPDATES - ESSA É A CHAVE!
    client = TelegramClient(SESSION_NAME, int(API_ID), API_HASH, 
                          receive_updates=False)  # ← AQUI!
...
if __name__ == "__main__":
    ...
    asyncio.run(test_connection_no_updates()) 