"""
test_connection_no_context.py
Teste SEM context manager para resolver o problema
"""
import asyncio
import os
import logging
...
async def test_connection_no_context():
    """Teste SEM context manager."""
    print("🔍 TESTE SEM CONTEXT MANAGER")
    print("="*50)
    ...
    try:
        # SEM CONTEXT MANAGER - CONEXÃO DIRETA
...
if __name__ == "__main__":
    ...
    asyncio.run(test_connection_no_context()) 